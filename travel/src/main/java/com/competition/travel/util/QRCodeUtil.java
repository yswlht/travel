package com.competition.travel.util;
...
public class QRCodeUtil {
     ...
     */
    public static boolean zxingCodeCreate(String content, String path, Integer size, String logoPath, int num) {
        try {
            //图片类型
            ...
            File file = new File(path + num + ".jpg");
            if (!file.exists()) {
                file.mkdirs();
            }
